              ...
              children: [
                Container(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                        String ret;
                        ret = value.isEmpty ? 'Employee ID can\'t be empty' : null;
                        try{
                          int.parse(value);
                        }
                        catch(e){
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    validator: (value) {
                        String ret;
                        ret = value.isEmpty ? 'Phone Number can\'t be empty' : null;
                ...
                Container(
                  ...
                  items: officeKeys != null ? officeKeys.
                ...
                Container(
                  ...
                  items: managerKeys != null ? managerKeys.
                          map<DropdownMenuItem<String>>((String value) {
                      return DropdownMenuItem<String>(
                        value: value,
